...
class PlotUtils:
    ...
    def plot_action_histogram(self):
        ...
        PATH = self.dir + self.name +"_noise_torque_"+ "_hip_action_histogram.png"
        plt.savefig(PATH)

        plt.figure()
        plt.hist(self.knee_action)
        plt.title("Knee action across episode")
        PATH = self.dir + self.name +"_noise_torque_"+ "_knee_action_histogram.png"
        plt.savefig(PATH)
    ...
    def plot_temporal_action_change(self):
        ...
        plt.legend()
        PATH = self.dir + self.name +"_noise_torque_"+ "_action_td.png"
        plt.savefig(PATH)
