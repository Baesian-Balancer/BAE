...
Actor-Critics
"""
def mlp_actor_critic(x, a, x_nxt, x_bar, hidden_sizes=(256,256), activation=tf.nn.relu, 
    ...
    with tf.variable_scope('pi', reuse=True):
        mu_nxt, pi_nxt, _ = policy(x_nxt, a, hidden_sizes, activation, output_activation)
    ...
    with tf.variable_scope('pi', reuse=True):
        mu_bar, pi_bar, _ = policy(x_bar, a, hidden_sizes, activation, output_activation)
