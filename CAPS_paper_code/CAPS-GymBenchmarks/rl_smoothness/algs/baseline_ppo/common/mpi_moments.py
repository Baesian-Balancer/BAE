...
import numpy as np
from rl_smoothness.algs.baseline_ppo.common import zipsame
...
def test_runningmeanstd():
    ...
    subprocess.check_call(['mpirun', '-np', '3', 
        'python','-c', 
        'from rl_smoothness.algs.baseline_ppo.common.mpi_moments import _helper_runningmeanstd; _helper_runningmeanstd()'])
