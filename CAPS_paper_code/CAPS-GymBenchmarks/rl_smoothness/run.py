import rl_smoothness
from rl_smoothness.user_config import DEFAULT_BACKEND
from rl_smoothness.utils.run_utils import ExperimentGrid
...
BASE_ALGO_NAMES = ['vpg', 'trpo', 'ppo', 'baseline_ppo', 'ddpg', 'td3', 'sac']
...
if __name__ == '__main__':
    ...
    if cmd in valid_help:
        ...
        help_msg = dedent("""
            ...
            \tpython -m rl_smoothness.run CMD [ARGS...]
        ...
        special_info = dedent("""
            ...
            \tpython -m rl_smoothness.run ppo --env HalfCheetah-v2 --clip_ratio 0.1

            If you need a quick refresher on valid kwargs, get the docstring
            with

            \tpython -m rl_smoothness.run [algo] --help
