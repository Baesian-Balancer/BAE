...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_kl', type=float, default=0.001)
    ...
    parser.add_argument('--start_ep_len', type=int, default=1000)
    ...
    parser.add_argument('--lam_ent', type=float, help='Entropy bonus (valid > 0)', default=.01)
